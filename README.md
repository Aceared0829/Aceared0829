...
基于 NVIDIA MotionBricks，探索 UE 动画数据与训练流程。

<sub>已有实验性导出与训练入口，真实资产端到端流程和生成质量待验证；UE 运行时推理尚未实现。</sub>
...
基于 AngelScript，探索受 Verse 启发的游戏脚本语言与工具链。

<sub>目前主要是基础工程、构建入口和 Rider 工具；语言扩展、UE 绑定与热更新仍在规划。</sub>
...
<sub>目前仅 Fork，尚未开始个人开发或复现；已有代码与演示来自<a href="https://github.com/jiashunwang/Hybrid-Motion-Imitation">上游</a>。</sub>
